...
process.on("unhandledRejection", errorHandler);
 ...
 if (process.argv.length < 7){console.log(`[FebryEnsz] : target time rate thread proxyfile`); process.exit();}
 const headers = {};
...
'ecdsa_secp521r1_sha512',
 ...
 const cplist = [ //Capctha_By_Lost_Api
...
const tips1 =[
 ...
 "LostC2 Created in 2020, Friends Who Supported me: @elitepowerproof / @ItsApi / @testibbxstress / @tronc2api"
];
...
const rateHeaders2 = [
 ...
 if (cluster.isMaster) {
    console.clear()
    console.log('\x1b[36m%s\x1b[0m', 'BOMB By FebryEnsz');
